			...
			'/channel/splice-in': {
				post: {
					...
					responses: {
						...
						'503': {
							description:
								'SPLICE_BUSY: the channel is momentarily unable to splice (a previous abort awaiting its echo, a peer-owned quiescence session, HTLCs still settling, the peer reconnecting). Retry the same request.'
						}
					}
				}
			},
