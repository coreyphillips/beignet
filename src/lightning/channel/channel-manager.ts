...
export class ChannelManager extends EventEmitter {
	...
	private handleChannelReady(peerPubkey: string, payload: Buffer): void {
		...
		// falls back to the temp map and promotes FIRST (the direct-funding
		// external-witness flush depends on handling seeing a live channel).
		// Dropping the message instead stalled the channel until something
		// else happened to re-send it.
