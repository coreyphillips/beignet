...
| `DUPLICATE_PAYMENT` | Payment hash already paid (known preimage or COMPLETED record, in memory or on disk), or still has an HTLC out; a failed attempt can be sent again |
